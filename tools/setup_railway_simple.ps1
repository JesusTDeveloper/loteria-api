...
Write-Host "1. Crear cuenta en Railway:" -ForegroundColor Yellow
...
Write-Host "2. Desplegar proyecto:" -ForegroundColor Yellow
...
Write-Host "4. Verificar despliegue:" -ForegroundColor Yellow
...
Write-Host "5. URLs de prueba:" -ForegroundColor Yellow
